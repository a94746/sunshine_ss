...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    private static final String MY_HEADER_CODE = "4255";
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        final String myHeader = request.getHeader("Secret");
        if (!StringUtils.hasLength(myHeader) || !MY_HEADER_CODE.equals(myHeader)) {
